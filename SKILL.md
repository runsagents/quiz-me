---
name: quiz-me
description: Quiz the human on their own codebase, recent changes by default. Use when the user says "quiz me", asks to be tested on their code, or wants to check they can still answer for agent-written changes.
---
